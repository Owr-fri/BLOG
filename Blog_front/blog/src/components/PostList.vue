<template>
  <div class="page-content">
    <div class="main-content" v-if="showPost">
      <div class="posts">
        <ul class="posts-ul">
          <li v-for="(item,index) in posts" :key="index" class="post-item">
            ...
            <div class="post-meta">
              ...
              <span class="post-cate">
                <span class="iconfont">&#xe7b8;</span>
                <span>分类于 </span>
                <a href="javascript:void(0)" @click="toCategory(item.categoryId,item.categoryName)">{{ item.categoryName }}</a>
              </span>
            </div>
            <div class="post-main">
    ...
    <div class="clear"></div>
    <el-pagination small :hide-on-single-page="isHide" @current-change="handleCurrentChange" :page-size="pageSize" :current-page="currentPage" layout="prev, pager, next" :total="total">
    </el-pagination>
    <div class="clear"></div>
    <GoTop />
  </div>
