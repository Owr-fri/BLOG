  ...
  <div class="home">
    ...
    <div class="content">
      <div class="warp">
        ...
        <div class="imglist">
          <el-image v-for="item in img" :key="item.id" :src="$API.BASE_SERVER_URL+item.img" :preview-src-list="srcList" lazy class="img-item">
          </el-image>
        </div>
      </div>
        ...
        <div class="recommend">
          ...
          <div v-for="item in recommendList" :key="item.id" class="img-card">
            <a :href="'/picture/'+item.title">
              <el-image :src="$API.BASE_SERVER_URL+item.img" fit="cover" class="picture-cover">
              </el-image>
            </a>
