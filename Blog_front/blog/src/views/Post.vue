      ...
      <h1>{{ title }}</h1>
        <div class="content">
          <div class="content-html">
            <mavon-editor class="md" ref="md" :value="content" :subfield="false" :defaultOpen="'preview'" :toolbarsFlag="false" :shortCut='false' :editable="false" :ishljs="true" @change="dataChange" />
          </div>
          <div class="side-nav">
